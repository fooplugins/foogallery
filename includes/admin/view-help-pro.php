...
<div id="pro_section" class="foogallery-admin-help-section" style="display: none">
    ...
    <section class="fgah-feature">
        ...
        <?php } elseif ( $show_thanks_for_pro ) { ?>
            <header>
                <h3>
                    <?php
                    echo sprintf(
                        esc_html__( 'Thanks for your support by purchasing a %s license 😍', 'foogallery' ),
                        '<span class="fgah-plan-' . esc_attr( $foogallery_current_plan ) . '">' .
                        esc_html( $foogallery_plans[ $foogallery_current_plan ] ) .
                        '</span>'
                    );
                    ?>
                </h3>
                ...
                <dl>
                    ...
                    <dd>
                        <div class="fgah-feature-sub-title">
                            ...
                            <?php
                            $available_plans = array_map(
                                function( $plan ) use ( $foogallery_plans ) {
                                    return '<span class="fgah-plan-' . esc_attr( $plan ) . '">' . esc_html( $foogallery_plans[ $plan ] ) . '</span>';
                                },
                                $feature['plans']
                            );
