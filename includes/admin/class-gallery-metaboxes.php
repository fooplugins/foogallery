...
if ( ! class_exists( 'FooGallery_Admin_Gallery_MetaBoxes' ) ) {
	...
	class FooGallery_Admin_Gallery_MetaBoxes {
		...
		public function render_gallery_shortcode_metabox( $post ) {
			...
			<input type="text" 
			id="foogallery_copy_shortcode" 
			size="<?php echo esc_attr( strlen( $shortcode ) + 2 ); ?>" 
				...
				<ul class="ul-disc">
					...
					?>
						<li>
							...
							<?php edit_post_link( __( 'Edit', 'foogallery' ), '<span class="edit">', ' | </span>', $post->ID ); ?>
							<span class="view">
								<a href="<?php echo esc_url( $url ); ?>" target="_blank"><?php esc_html_e( 'View', 'foogallery' ); ?></a>
							</span>
						</li>
					<?php endforeach; ?>
				</ul>
		...
		public function render_sorting_metabox( $post ) {
			...
			foreach ( $sorting_options as $sorting_key => $sorting_label ) { ?>
				<p>
					<input type="radio" 
						   value="<?php echo esc_attr( $sorting_key ); ?>" 
						   <?php checked( $sorting_key === $gallery->sorting ); ?> 
						   id="FooGallerySettings_GallerySort_<?php echo esc_attr( $sorting_key ); ?>" 
						   name="<?php echo esc_attr( FOOGALLERY_META_SORT ); ?>" />
					<label for="FooGallerySettings_GallerySort_<?php echo esc_attr( $sorting_key ); ?>">
						<?php echo esc_html( $sorting_label ); ?>
					</label>
				</p>
			<?php } ?>
			...
			foreach ( $retina_options as $retina_key => $retina_label ) {
				...
				<p>
					<input type="checkbox" 
						   value="true" 
						   <?php checked( $checked ); ?> 
						   id="FooGallerySettings_Retina_<?php echo esc_attr( $retina_key ); ?>" 
						   name="<?php echo esc_attr( FOOGALLERY_META_RETINA ); ?>[<?php echo esc_attr( $retina_key ); ?>]" />
					<label for="FooGallerySettings_Retina_<?php echo esc_attr( $retina_key ); ?>">
						<?php echo esc_html( $retina_label ); ?>
					</label>
				</p>
			<?php } ?>
			<p class="foogallery-help">
		...
		public function render_thumb_settings_metabox( $post ) {
			...
			<p>
				...
				value="true" 
				<?php checked( $checked ); ?> 
				id="FooGallerySettings_ForceOriginalThumbs" 
				name="<?php echo esc_attr( FOOGALLERY_META_FORCE_ORIGINAL_THUMBS ); ?>" />
		...
		public function render_customcss_metabox( $post ) {
			...
			$example = '<code>#foogallery-gallery-' . esc_attr( $post->ID ) . ' { }</code>';
			?>
			<p>
				<?php
				printf(
					esc_html__( 'Add any custom CSS to target this specific gallery. For example %s', 'foogallery' ),
			...
			<table id="table_styling" class="form-table">
				<tbody>
					<tr>
						<td>
							<textarea class="foogallery_metabox_custom_css" 
									  name="<?php echo esc_attr( FOOGALLERY_META_CUSTOM_CSS ); ?>" 
									  type="text"><?php echo esc_textarea( $custom_css ); ?></textarea>
						</td>
					</tr>
				</tbody>
			</table>
