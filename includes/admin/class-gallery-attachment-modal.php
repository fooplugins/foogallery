					...
					<section id="foogallery-panel-thumbnails" class="tab-panel">
						<div class="settings">
							...
							<span class="setting" data-setting="generated-thumbnails">
								...
								<span><?php echo esc_html( $wp_thumbnails ) . ' ' . esc_html__( 'generated by WordPress;', 'foogallery' ) . ' ' . esc_html( $foogallery_thumbnails ) . ' ' . esc_html__( 'generated by FooGallery;', 'foogallery' ); ?> </span>												
							</span>
