...
$text_prev_default = esc_html( foogallery_get_setting( 'language_imageviewer_prev_text',  __( 'Prev', 'foogallery' ) ) );
$text_prev = foogallery_gallery_template_setting( 'text-prev', $text_prev_default ) ;

$text_of_default = esc_html( foogallery_get_setting( 'language_imageviewer_of_text', __( 'of', 'foogallery' ) ) );
$text_of = foogallery_gallery_template_setting( 'text-of', $text_of_default );

$text_next_default = esc_html( foogallery_get_setting( 'language_imageviewer_next_text', __('Next', 'foogallery') ) );
