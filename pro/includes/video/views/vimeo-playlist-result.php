	...
	echo '<div class="foovideo-result foovideo-playlist">';
		...
		echo '<div class="foovideo-details">';
			...
			echo '<div class="foovideo-meta">';
				echo __('by', 'foogallery' ) . ' <a href="' . $results['stream']['owner']['url'] . '" target="_blank">' . $results['stream']['owner']['display_name'] . '</a>';
				echo ' &bull; ' . sprintf( _n( '%s video', '%s videos', $results['stream']['total_clips'], 'foogallery' ), $results['stream']['total_clips'] );
			echo '</div>';
